...
export default function Card({
  ...
  return (
    <div className="absolute bottom-0 w-dvw border-l-4 border-t-4 z-50 p-4 bg-white rounded-tl-2xl rounded-tr-2xl flex-col justify-start items-start gap-4 inline-flex">
